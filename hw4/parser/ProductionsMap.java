...
class ProductionsMap {
	...
	expMap.put(TerminalSymbol.PLUS, SymbolSequence.build(TerminalSymbol.PLUS, NonTerminalSybmol.TERM, NonTerminalSymbol.EXPRESSION_TAIL));
	expMap.put(TerminalSymbol.MINUS, SymbolSequence.build(TerminalSymbol.MINUS, NonTerminalSybmol.TERM, NonTerminalSymbol.EXPRESSION_TAIL));
